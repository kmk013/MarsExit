...
public class GameManager : MonoBehaviour {
	...
	public List<string> dropQ = new List<string> ();
	...
	public GameObject meat3DP;
	public GameObject water3DP;
	...
	void Start () {
		...
		mainPlayer = Instantiate (playerP, new Vector3 (Random.Range (-64.5f, 825), 5, Random.Range (-64.5f, 825)), Quaternion.identity) as GameObject;
		...
		inventoryUIG.SetActive (true);
		inventoryUIG.SetActive (false);
